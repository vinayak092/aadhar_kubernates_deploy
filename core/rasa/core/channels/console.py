...
async def send_message_receive_block(server_url, auth_token, sender_id, request_id, user_id, message):
    payload = {"sender": sender_id, "request_id": request_id, "user_id" "message": message}
...
async def send_message_receive_stream(server_url, auth_token, sender_id, request_id, user_id, message):
    ...
    while not utils.is_limit_reached(num_messages, max_message_limit):
        ...
        if use_response_stream:
            bot_responses = send_message_receive_stream(
                server_url, auth_token, sender_id, request_id, user_id, text
            )
